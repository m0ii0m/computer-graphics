...
bool Initialise()
{
    ...
    // Shader
    g_BasicShader.LoadVertexShader("MultiText.vs");
    g_BasicShader.LoadFragmentShader("MultiText.fs");
...
void Render()
{
    ...
    // Rendu du Cube
    {
        ...
        // Liaison des textures par défaut
        ...
        glBindTexture(GL_TEXTURE_2D, defaultTex);
        glUniform1i(glGetUniformLocation(basicProgram, "u_secondTexture"), 1);
