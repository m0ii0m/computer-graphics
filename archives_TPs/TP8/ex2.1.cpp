...
bool Initialise()
{
    ...
    // Shader
    g_BasicShader.LoadVertexShader("ex2.1.vs");
    g_BasicShader.LoadFragmentShader("GammaAuto.fs");
...
void Render()
{
    ...
    // Ex2.1 : view Matrix via LookAt
    Vector3D camPos = { 5.0f, 5.0f, 5.0f };
    Vector3D camTarget = { 0.0f, 0.0f, -5.0f };
    ...
    // Rendu du Cube
    {
        ...
        Matrix4 trans = Translate(-2.5f, 0.0f, -5.0f);
    ...
    // Rendu du Dragon
    {
        ...
        Matrix4 trans = Translate(2.0f, -1.0f, -5.0f);
