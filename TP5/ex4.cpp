...
bool Initialise()
{
    ...
    // Shader
    g_BasicShader.LoadVertexShader("PhongFull.vs");
    g_BasicShader.LoadFragmentShader("PhongFull.fs");
...
void Render()
{
    ...
    glUniform3f(glGetUniformLocation(basicProgram, "u_light.diffuseColor"), 0.8f, 0.8f, 0.8f);
